...
class Relatorio:
    ...
    def Adicionar(self):
        ...
        self.relatorio.to_csv(rf"{BASE_DIR}\{UPLOADCSV}\relatorio.csv")
    ...
    def Converte(self):
        ...
        self.relatorio.to_excel(rf"{BASE_DIR}\{UPLOADXLSX}\relatorio_atualizado.xlsx", index=False)
    ...
    def Salva(self):
        ...
        if os.path.exists((rf"{BASE_DIR}\{UPLOADXLSX}\relatorio_atualizado.xlsx")):
            self.wb.save(rf"{BASE_DIR}\{HISTORICO}\{hoje}relatorio_atualizado.xlsx")
            self.relatorio.to_excel(rf"{BASE_DIR}\{HISTORICO}\{hoje}relatorio_atualizado.xlsx", index=False)
        else:
            self.wb.save(rf"{BASE_DIR}\{UPLOADXLSX}\relatorio_atualizado.xlsx")
